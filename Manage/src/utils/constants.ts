...
/**
 * @description 七牛云CDN地址
 */
export const CDN: string = 'http://cdn.serberina.cn/';
/**
 * @description 上传地址
 * @dev http://127.0.0.1:7001/api/systems/qiniu
 * @prod http://node.serberina.cn/api/systems/qiniu
 */
 ...
 */
export const PROXY: string = 'http://localhost:7002';
